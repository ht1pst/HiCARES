...
const faqs = [
 {
  question: "What skilled nursing services do you provide?",
  answer:
    "Our licensed nurses provide a range of professional services, including health assessments, medication management, wound care, chronic disease management, post-hospital care, patient education, and care coordination.",
},
{
  question: "Do I need a physician's referral for skilled nursing care?",
  answer:
    "Depending on your needs and insurance requirements, a physician's referral may be required. Our team can guide you through the process and help determine the appropriate next steps.",
},
{
  question: "Who provides skilled nursing care?",
  answer:
    "Our skilled nursing services are delivered by licensed, experienced nurses who are committed to providing safe, compassionate, and high-quality care in the comfort of your home.",
},
{
  question: "Can skilled nursing services be combined with other home care services?",
  answer:
    "Yes. Skilled nursing can be combined with other HiCARES services, such as personal care, homemaker services, companion care, and medication assistance, to create a comprehensive care plan tailored to your needs.",
},
];
function FAQ2(){
