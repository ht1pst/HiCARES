...
const faqs = [
  {
    question: "What Respite Care services do you provide?",
    answer:
      "Our Respite Care provides temporary relief for family caregivers while ensuring their loved ones continue receiving compassionate and dependable care in the comfort of home.",
  },
  {
    question: "Who can benefit from Respite Care?",
    answer:
      "Respite Care can benefit family caregivers who need time to rest, recharge, attend to personal responsibilities, or take a temporary break while their loved one continues receiving appropriate support.",
  },
  {
    question: "How long can Respite Care be provided?",
    answer:
      "Respite Care is designed to provide temporary support based on the needs of the client and family caregiver. Our team can help determine an appropriate care arrangement.",
  },
  {
    question: "Can Respite Care be combined with other home care services?",
    answer:
      "Yes. Respite Care can be combined with other HiCARES services to help ensure your loved one continues receiving the appropriate support while providing family caregivers with needed relief.",
  },
];
function FAQ7(){
