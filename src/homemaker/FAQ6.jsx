...
const faqs = [
  {
    question: "What Homemaker Services do you provide?",
    answer:
      "Our Homemaker Services include meal preparation, laundry, light housekeeping, vacuuming, dusting, changing bed linens, grocery shopping, and household organization to help maintain a clean, safe, and comfortable home.",
  },
  {
    question: "Who can benefit from Homemaker Services?",
    answer:
      "Homemaker Services are ideal for individuals who need assistance with everyday household tasks while wishing to remain safe, comfortable, and independent in their own home.",
  },
  {
    question: "Can Homemaker Services be customized to my needs?",
    answer:
      "Yes. We tailor our Homemaker Services to each client's lifestyle, preferences, and daily routine, ensuring they receive the support that best fits their individual needs.",
  },
  {
    question: "Can Homemaker Services be combined with other home care services?",
    answer:
      "Yes. Homemaker Services can be combined with other HiCARES services, such as personal care, companion care, medication assistance, and skilled nursing to create a personalized care plan.",
  },
];
function FAQ6(){
