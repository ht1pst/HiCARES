...
import img2 from "../assets/careersheroimg.webp";
...
<div
  className="relative z-10 min-h-screen bg-cover bg-center flex items-center lg:pt-20 pt-25"
...
>
  ...
  ease: "easeOut", }}
      ...
      <motion.h1 className="text-white text-[40px] lg:text-7xl font-bold leading-tight lg:leading-[70px]"
      initial={{ opacity: 0, y: 40 }}       // starts slightly below and invisible
  whileInView={{ opacity: 1, y: 0 }}    // slides up into view
  viewport={{ once: true, amount: 0.3 }} // animate only the first time
  transition={{
  ...
  ease: "easeOut", }}
      >
      Make a meaningful difference in the lives of others while building a
  rewarding career with HiCARES. Join a team committed to compassionate,
  dependable, and person-centered care.
      </motion.p>
