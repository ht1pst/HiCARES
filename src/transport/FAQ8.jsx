...
const faqs = [
  {
    question: "What Transportation & Errand services do you provide?",
    answer:
      "Our Transportation & Errand services help clients safely and conveniently manage essential trips, including medical appointments, pharmacy visits, grocery shopping, banking, essential errands, and community activities.",
  },
  {
    question: "Who can benefit from Transportation & Errand services?",
    answer:
      "These services can benefit clients who need assistance getting to appointments, completing essential errands, accessing community activities, or maintaining their independence outside the home.",
  },
  {
    question: "Can transportation be used for medical appointments?",
    answer:
      "Yes. We can provide transportation support for medical appointments, pharmacy visits, and other essential healthcare-related trips as part of the client's care needs.",
  },
  {
    question: "Can Transportation & Errand services be combined with other home care services?",
    answer:
      "Yes. Transportation & Errand services can be combined with other HiCARES services to provide clients with comprehensive support that promotes independence, safety, and continued community involvement.",
  },
];
function FAQ8(){
