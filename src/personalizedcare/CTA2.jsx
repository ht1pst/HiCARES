...
function CTA2(){
    return(
      ...
      >
        ...
        transition={{ duration: 0.8, ease: "easeOut" }}
                >
                   Every individual has unique needs, goals, and preferences. At HiCARES,
  we create personalized care plans that deliver the right level of support,
  helping clients live comfortably, safely, and independently while giving
  families confidence and peace of mind.
                </motion.p>
        ...
        transition={{ duration: 0.8, ease: "easeOut" }}
                    >
                     ...
                     Individualized <br className="lg:block hidden" />
  Care Plans
                    </motion.p>
                  </div>
        ...
        transition={{ duration: 0.8, ease: "easeOut" }}
                    >
                       Flexible <br className="lg:block hidden"/>
  Support
                    </motion.p>
                  </div>
        ...
        transition={{ duration: 0.8, ease: "easeOut" }}
                    >
                      Safe & <br className="lg:block hidden"/>
  Reliable Care
                    </motion.p>
                  </div>
        ...
        transition={{ duration: 0.8, ease: "easeOut" }}
                    >
                       Family-Centered <br className="lg:block hidden"/>
  Approach
                    </motion.p>
                  </div>
