...
const faqs = [
  {
    question: "How is my personalized care plan created?",
    answer:
      "Every care plan begins with an assessment of your health, daily routine, goals, and personal preferences. We use this information to develop a plan tailored to your unique needs.",
  },
  {
    question: "Can my care plan change over time?",
    answer:
      "Yes. As your needs change, we can review and update your care plan to ensure you continue receiving the right level of support.",
  },
  {
    question: "Can family members be involved in creating the care plan?",
    answer:
      "Absolutely. We encourage family members and loved ones to participate in the planning process so everyone understands the care being provided.",
  },
  {
    question: "Is a personalized care plan available for both short-term and long-term care?",
    answer:
      "Yes. We create care plans for clients who need temporary assistance as well as those requiring ongoing support.",
  },
];
function FAQ(){
