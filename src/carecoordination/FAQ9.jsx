...
const faqs = [
  {
    question: "What does Care Coordination involve?",
    answer:
      "Our Care Coordination services help connect clients, families, physicians, hospitals, social workers, and case managers to ensure care is organized, consistent, and centered around the client's individual needs.",
  },
  {
    question: "Who is involved in the care coordination process?",
    answer:
      "Care coordination may involve the client, family members, physicians, hospitals, social workers, case managers, and other healthcare providers involved in the client's care.",
  },
  {
    question: "How does Care Coordination benefit clients?",
    answer:
      "Care Coordination helps ensure important information is shared among the appropriate care team members, supporting continuity of care, better communication, and a more coordinated approach to the client's needs.",
  },
  {
    question: "Can Care Coordination be combined with other home care services?",
    answer:
      "Yes. Care Coordination can work alongside other HiCARES services to help ensure clients receive consistent, individualized support while their care team remains informed and connected.",
  },
];
function FAQ9(){
