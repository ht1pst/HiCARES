...
<section className="h-auto pb-10 lg:px-[30px] py-[10px]">
    ...
    >
<h1 className=" mt-4 text-[#1E3A5F] text-[30px] text-center lg:text-4xl font-bold ">Anyone Can Help Connect Someone To Care</h1>

<div className="border border-2 border-[#2EC4B6] w-[100px] mt-3 flex justify-center mx-auto"></div>


<div className="mt-20 flex flex-col lg:flex-row  justify-center lg:gap-10 gap-20">

<div className="border relative border-gray-200 mx-auto pt-[50px] border-3 rounded-xl w-[300px]  flex flex-col  items-center h-[220px]">
